...
public class charmain {
    ...
    public void mainclass(String[]list){
        // String a="ali eve gel";
        // String b="eve gel sonra";//başında olunca sıkıntılıııı
        // String c="eve gel sonra carsi";
        // String d="carsiya git";
        // String e="carsiya git sonra";
        // String f="carsiya git sonra yumurta al";

        String a = "bugun okuldan eve geldim ve ustumu degistirdim sonra elimi yikadim ve mutfaga gittim ";
        String b = "ahhh sonra elimi yikadim ve mutfaga gittim annem cok guzel kokan yemek hazirlamisti geldim ve yedim"; 
        String c = "hazirlamisti geldim ve yedim oturma odasina gectim televizyon izledim";
        String d = "izledim en sevdigim program bitince yatagima gittim";
        String e = "gittigim gibi misil misil uyudum.";

        listkeeper string1 = new listkeeper(a);
        listkeeper string2 = new listkeeper(b);
        listkeeper string3 = new listkeeper(c);
        listkeeper string4 = new listkeeper(d);
        listkeeper string5 = new listkeeper(e);
        //listkeeper string6 = new listkeeper(f);
        ...
        if(x.size()<1){
            System.out.println("cümleler birleştirilemedi");
        }
    ...
    public static ArrayList<listkeeper> find_most_similarity(ArrayList<listkeeper> x){
        ...
        for (int i = 0; i < list.size(); i++) {
            for (int j = 0; j < list.size(); j++) {
                if(list.get(i)==list2.get(j) && list.get(j)==list2.get(i)){
                    list.remove(j);
                    list2.remove(j);
                    list3.remove(j);
                    list5.remove(j);
        ...
        for (int i = 0;i<list4.size(); i+=2) {
            for (int j = 0; j < list3.size(); j++) {
                counter=0;
                if(list4.get(i+1)==list.get(j) && list4.get(i)!=list2.get(j) && list5.get(j)>list6.get(j) && list3.get(j)>=max){
                    ...
                    index=j;
                    index2=0;
                }else if(list4.get(i+1)==list2.get(j) && list4.get(i)!=list.get(j) && list5.get(j)<list6.get(j) && list3.get(j)>=max){
                    counter=func(list4, list2, list, j);
                    if (counter==1)
                        continue;
                    max=list3.get(j);
                    index=j;
                    index2=1;
                }else if(list4.get(i+1)==list.get(j) && list4.get(i)!=list2.get(j) && list5.get(j)==list6.get(j) && list3.get(j)>=max){
                    counter=func(list4, list2, list, j);
                    if (counter==1)
                        continue;
    ...
    public ArrayList<Character> func1(String lastword,String b){
        ArrayList<Integer> list = new ArrayList<Integer>();
        ArrayList<Integer> list2 = new ArrayList<Integer>();
        ArrayList<Integer> list3 = new ArrayList<Integer>();
    ...
    public ArrayList<Integer> find_max_size_index(ArrayList<Integer> list2){
        int counter=1;
        ArrayList<Integer> list3 = new ArrayList<Integer>();
